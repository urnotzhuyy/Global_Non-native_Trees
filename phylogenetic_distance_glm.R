...
colnames(pd_global) <- c("species_wcvpname", "probability", "pdmean", "pdmin", "region")
...
colnames(threatenedpd_global) <- c("species_wcvpname", "probability", "pdmean", "pdmin", "region")
...
ggplot(threatenedpd_global, aes(x = pdmean_sta,y = probability)) +
  ...
  scale_y_continuous(breaks = c(0, 0.05, 0.10),
                     labels = c(0, sprintf("%.3f", c(0.05, 0.10)))) +
...
colnames(nonthreatenedpd_global) <- c("species_wcvpname", "probability", "pdmean", "pdmin", "region")
...
ggplot(nonthreatenedpd_global, aes(x = pdmean_sta,y = probability)) +
  ...
  scale_y_continuous(breaks = c(0, 0.2, 0.4, 0.6),
                     labels = c(0, sprintf("%.3f", c(0.2, 0.4, 0.6)))) +
  scale_x_continuous(breaks = seq(-4, 6, 2)) +
  theme(panel.background = element_blank(),
        axis.line = element_line(),
        axis.text = element_text(family = "Times New Roman", size = 10),
